...
<body>
  ...
  <main class="">
    ...
    <div class="grid gap-2 mb-6 md:grid-cols-2 w-2/3 mx-auto">
        <div>
            <label for="name" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">名前</label>
        ...
        <div>
            <label for="university" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">大学</label>
        ...
        <div>
            <label for="faculty" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">学部</label>
        ...
        <div>
            <label for="posse" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">所属posse</label>
            <input type="text" id="posse" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?= $student["posse"] . $student["grade"]?>" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" disabled>
        </div>
    </div>
